...
/**
 * @brief Handles keyboard events for the rename dialog.
 *
 * Processes keyboard actions generated by the LVGL
 * keyboard widget. When the user confirms the input,
 * the sensor name and placement settings are updated.
 * When cancelled, the dialog is closed without applying
 * changes.
 *
...
/**
 * @brief Handles clicks outside the rename panel.
 *
 * Closes the rename overlay when the background scrim
 * is clicked.
 *
 * @param e LVGL event data.
 */
